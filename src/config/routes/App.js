...
import { CATALOG, CATALOGID, CHANGEPASSWORDPAGES, CONTACT, CREATEEMPLOYEESPAGES, CREATEEMPLOYEESSPAGES, EDITEMPLOYEESPAGES, EDITPRODUCTS, EDITPROFILE, EMPLOYEESPAGES, ERRORPAY, FORMADDPRODUCTS, FORMADMIN, FORMLOGIN, FORMPROVIDERPRODUCTSPAGES, FORMREGISTER, HOME, LISTPROVIDERPRODUCTS, LOGIN, LOGINADMIN, MANAGEPRODUCTS, PRODUCTSPAGES, PROFILE, REGISTER, SHOPPINGCART, SUCCESSPAY, SuccessPay } from "./path";
...
function App() {
  return (
     ...
     <UserContextProvider>
      ...
      <Route path={EDITPRODUCTS} element={<FormAddProducts/>} />
